                                ...
                                <div className="event-details">
                                    <div className="event-hero-wrapper py-4 md:py-12">
                                        <div className="event-hero">
                                            <img src={id <= 20 ? `${event.image}` : `http://localhost:5000/${event.image.substring(7)}`} alt="" className="md:max-w-[1100px] md:min-w-[1080px] md:mx-auto" />
                                        </div>
                                    </div>
                                                                            ...
                                                                            <span>
                                                                                {
                                                                                    dateStart === dateEnd ?
                                                                                        (
                                                                                            <>
                                                                                                {dateStart} · {event.dateTimeStart[1]} - {event.dateTimeEnd[1]}
                                                                                        ...
                                                                                        (
                                                                                            <>
                                                                                                {dateStart} · {event.dateTimeStart[1]} <br /> - {dateEnd} · {event.dateTimeEnd[1]}
                                                                                            </>
                                                                                        )
                                                                                }
